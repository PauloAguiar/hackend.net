...
class CustomTestRinhaBackendCrebitosSimulation
  extends Simulation {
  ...
  setUp(
    validacaoTransacoesConcorrentes("d").inject(
      ...
      criterioClienteNaoEcontrado.inject(
        ...
        debitos.inject(
          rampUsersPerSec(1).to(600).during(20.seconds),
          constantUsersPerSec(600).during(40.seconds)
        ),
        creditos.inject(
          rampUsersPerSec(1).to(300).during(20.seconds),
          constantUsersPerSec(300).during(40.seconds)
        ),
        extratos.inject(
          rampUsersPerSec(1).to(40).during(20.seconds),
