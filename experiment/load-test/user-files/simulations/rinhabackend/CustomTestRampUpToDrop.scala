  ...
  setUp(
    validacaoTransacoesConcorrentes("d").inject(
      ...
      criterioClienteNaoEcontrado.inject(
        ...
        debitos.inject(
          rampUsersPerSec(1).to(1500).during(60.seconds)
        ),
        creditos.inject(
          rampUsersPerSec(1).to(750).during(60.seconds)
        ),
        extratos.inject(
          rampUsersPerSec(1).to(90).during(60.seconds)
        )
      )
    )
